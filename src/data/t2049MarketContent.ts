...
export const T2049_TRADERS: readonly MarketTrader[] = [
  ...
  { id: 'seat-c', trader: 'Trader C', exchange: 'Variational', logo: 'symbol/variational.svg', color: '#ff9f5d' },
  { id: 'seat-d', trader: 'Trader D', exchange: 'Variational', logo: 'symbol/variational.svg', color: '#c98dff' },
  { id: 'seat-e', trader: 'Trader E', exchange: 'Polymarket', logo: 'symbol/polymarket-avatar.png', color: '#5dffb0' },
  { id: 'seat-f', trader: 'Trader F', exchange: 'Polymarket', logo: 'symbol/polymarket-avatar.png', color: '#ff6f9c' },
  { id: 'seat-g', trader: 'Trader G', exchange: 'Polymarket', logo: 'symbol/polymarket-avatar.png', color: '#ffe45d' },
  { id: 'seat-h', trader: 'Trader H', exchange: 'Polymarket', logo: 'symbol/polymarket-avatar.png', color: '#8d9cff' },
];
